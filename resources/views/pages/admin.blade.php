    ...
    <div class="widget-author widget-auth-form boxed">
        <div class="row">
            <div class="col-xs-10  col-xs-offset-1">
                ...
                <form class="form-horizontal" method="POST" action="/lar-admin">
                    @csrf
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" placeholder="Адрес e-mail, указанный при регистрации" value="{{old('email','')}}" name="email">
                        </div>
                    </div>
                    <div class="form-group">
